...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\017\000\010\006\010\010\004\011\006\001\002\000" +
    "\012\002\ufffb\004\ufffb\005\ufffb\007\ufffb\001\002\000\012" +
    "\002\ufffe\004\ufffe\005\016\007\ufffe\001\002\000\012\002" +
    "\ufffa\004\ufffa\005\ufffa\007\ufffa\001\002\000\012\002\ufffc" +
    "\004\ufffc\005\ufffc\007\ufffc\001\002\000\010\006\010\010" +
    "\004\011\006\001\002\000\006\002\000\004\014\001\002" +
    "\000\004\002\013\001\002\000\004\002\001\001\002\000" +
    "\010\006\010\010\004\011\006\001\002\000\012\002\uffff" +
    "\004\uffff\005\016\007\uffff\001\002\000\010\006\010\010" +
    "\004\011\006\001\002\000\012\002\ufffd\004\ufffd\005\ufffd" +
    "\007\ufffd\001\002\000\006\004\014\007\021\001\002\000" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\017\000\012\002\011\003\010\004\004\005\006\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\002\001\001\000\010\003\017\004\004\005\006\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\006\004\014\005\006\001\001\000\002\001\001\000" +
      ...
      switch (CUP$Parser$act_num)
		...
		RESULT = start_val;
          ...
          case 1: // inicio ::= sig 
            {
              Object RESULT =null;
		insertarNodoPadreTodos();
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("inicio",0, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // sig ::= sig SUMA sig2 
            {
              Object RESULT =null;
		...
		generarUnion(String.valueOf(s),String.valueOf(s2),"+");RESULT = numNodo;
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("sig",1, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		RESULT = e;
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("sig",1, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // sig2 ::= sig2 MULT expr 
            {
              Object RESULT =null;
		int sleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int sright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
		...
		int eright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Object e = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		generarUnion(String.valueOf(s),String.valueOf(e),"*");RESULT = numNodo;
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("sig2",2, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		RESULT = String.valueOf(e);
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("sig2",2, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		crearNodo(String.valueOf(e));RESULT = numNodo;
